        ...
        <div class="flex">
            ...
            <div class="md:pl-64 flex flex-col flex-1">
                    ...
                    <div x-show="open" x-transition:enter="transition ease-in-out duration-300 transform" x-transition:enter-start="-translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transition ease-in-out duration-300 transform" x-transition:leave-start="translate-x-0" x-transition:leave-end="-translate-x-full" class="relative flex-1 flex flex-col max-w-xs w-full bg-white">
                        ...
                        <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                            ...
                            <nav class="mt-5 px-2 space-y-1">
                                ...
                                <a href="{{ route('user.profile.edit') }}" class="{{ request()->routeIs('user.profile.edit') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-600 hover:bg-gray-50' }} group flex items-center px-2 py-2 text-base font-medium rounded-md">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="{{ request()->routeIs('user.profile.edit') ? 'text-indigo-500' : 'text-gray-400 group-hover:text-gray-500' }} mr-4 flex-shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <main class="flex-1">
                    ...
                    <div class="py-6">
                        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:pt-16">
                            {{ $slot }}
                        </div>
                    </div>
                </main>
